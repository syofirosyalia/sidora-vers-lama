...
<head>
  ...
  <title>SIDORA PART II</title>
  <meta content="" name="description">

  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="{{ asset('assets/user/img/logo1.png') }}" rel="">
...
<body>
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto " href="#tentangdarah">Tentang Darah</a></li>
          <li><a class="nav-link scrollto " href="#agendadonor">Agenda Donor</a></li>
          <li><a class="nav-link scrollto " href="#stokdarah">Stok Darah</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          <h2 data-aos="fade-up">KATAKAN SIDORA</h2>
  ...
  <main id="main">
    <!-- ======= About Section ======= -->
    <section id="tentangdarah" class="tentangdarah">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <!-- ======= Services Section ======= -->
    <section id="agendadonor" class="agendadonor">
    ...
    <!-- ======= Portfolio Section ======= -->
    <section id="stokdarah" class="stokdarah">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <p>Web</p>
                <div class="portfolio-links">
                  <a href="{{ asset('assets/user/img/portfolio/portfolio-2.jpg') }}" data-gallery="portfolioGallery" class="portfokio-lightbox" title="Web 3"><i class="bi bi-plus"></i></a>
                  <a href="portfolio-details.html" title="More Details"><i class="bi bi-link"></i></a>
                </div>
              </div>
            </div>
